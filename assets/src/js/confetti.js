  ...
  (!(function t(e, n, a, i) {
    ...
    function S(t, n) {
      ...
      function d(n) {
        ...
        function b() {
          ((a = null),
            r && e.removeEventListener("resize", g),
        ...
        return (
          ...
          r && e.addEventListener("resize", g, !1),
          s
            ? s.fire(n, m, b)
            : (function (e, n, i) {
                for (
                  var o,
                    ...
                    l,
                    c,
                    s = y(e, "particleCount", w),
                    h = y(e, "angle", Number),
                    f = y(e, "spread", Number),
                    d = y(e, "startVelocity", Number),
                    m = y(e, "decay", Number),
                    g = y(e, "gravity", Number),
                    b = y(e, "drift", Number),
                    v = y(e, "colors", C),
                    M = y(e, "ticks", Number),
                    p = y(e, "shapes"),
                  ...
                  k.push(
                    ...
                    (l = o.spread * (Math.PI / 180)),
                    {
                      ...
                      velocity:
                        0.5 * o.startVelocity + Math.random() * o.startVelocity,
                ...
                return a ? a.addFettis(k) : (a = E(t, k, u, n, i)).promise;
              })(n, m, b)
        );
      }
      return (
