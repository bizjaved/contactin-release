            ...
            if ($attachmentBtn.length && $attachmentHidden.length) {
              $attachmentBtn.off('click').on('click', function () {
                ...
                if (newEnabled && !isRestApiEnabled()) {
                  showDependencyDialog('File attachment requires the REST API service. Enable REST API as well?', function () {
            ...
            if ($subjectBtn.length && $subjectHidden.length) {
              $subjectBtn.off('click').on('click', function () {
                ...
                if (!newEnabled && isRestApiEnabled()) {
                  showDependencyDialog('Disabling the subject field while REST API is enabled may affect integrations. Proceed?', function () {
        ...
        if ($attachmentBtn.length && $attachmentHidden.length) {
          ...
          $(document).on('cin:settings:saved', function () {
    ...
    if ($salutationBtn.length && $salutationHidden.length) {
      $salutationBtn.on('click', function () {
