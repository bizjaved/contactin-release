	...
	<div style="display: flex; align-items: flex-start; gap: 12px;">
		...
		<div style="flex: 1;">
			<h3 style="margin: 0 0 8px 0; color: #1d2327; font-size: 16px;">
				<?php esc_html_e( 'Love this plugin?', 'contactin' ); ?>
			</h3>
			<p style="margin: 0 0 12px 0; color: #646970; font-size: 13px; line-height: 1.6;">
				<?php esc_html_e( 'It\'s 100% free and built with passion. Your support helps us continue developing amazing features.', 'contactin' ); ?>
			</p>
			<a href="https://www.paypal.com/ncp/payment/TGXL9QCSX3FSG"
				...
				aria-label="<?php esc_attr_e( 'Donate via PayPal to support ContactIn', 'contactin' ); ?>">
				<span style="margin-right: 6px;">☕</span>
				<?php esc_html_e( 'Buy Us Coffee', 'contactin' ); ?>
			</a>
		</div>
	</div>
</div>
