    ...
    <div style="display: flex; align-items: flex-start; gap: 12px;">
        ...
        <div style="flex: 1;">
            <h3 style="margin: 0 0 8px 0; color: #1d2327; font-size: 16px;">
                <?php esc_html_e( 'Enjoying Contact Inbox?', 'contact-inbox-hub' ); ?>
            </h3>
            <p style="margin: 0 0 12px 0; color: #646970; font-size: 13px; line-height: 1.6;">
                <?php esc_html_e( 'Help other WordPress users discover this plugin by leaving a 5-star review on WordPress.org. Your feedback means a lot to us!', 'contact-inbox-hub' ); ?>
            </p>
            <a href="https://wordpress.org/support/plugin/contact-inbox-hub/reviews/"
               ...
               aria-label="<?php esc_attr_e( 'Leave a review for Contact Inbox on WordPress.org', 'contact-inbox-hub' ); ?>">
                <span style="margin-right: 6px;">✍️</span>
                <?php esc_html_e( 'Leave a Review', 'contact-inbox-hub' ); ?>
            </a>
        </div>
    </div>
</div>
