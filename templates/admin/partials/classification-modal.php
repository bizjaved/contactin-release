...
#cin-classification-modal .contactin-modal-header { padding: 16px 20px; }
#cin-classification-modal .contactin-modal-body {
    padding: 24px 20px;
    flex: 1 1 auto;
    overflow-y: auto;
}
#cin-classification-modal .contactin-modal-footer { padding: 16px 20px; }
...
.cin-classification-btn .dashicons { font-size: 20px; width: 20px; height: 20px; }
...
.cin-classification-btn.cin-current .dashicons { color: #2271b1; }
...
.cin-classification-btn.cin-selected .dashicons { color: #fff; }
#cin-classification-modal.processing .cin-classification-btn:not(.cin-selected) {
    opacity: 0.5;
    cursor: not-allowed;
    pointer-events: none;
}
#cin-classification-modal.processing .cin-classification-btn.cin-selected { pointer-events: none; }
.cin-category-label {
    display: block;
    font-size: 13px;
    line-height: 1.4;
...
.cin-modal-title { font-size: 16px; font-weight: 600; color: #1d2327; }
.cin-modal-close { color: #646970; transition: color 0.15s ease; }
.cin-modal-close:hover { color: #1d2327; }
.cin-footer-actions {
    width: 100%;
    display: flex;
...
CSS;
wp_add_inline_style('contactin-admin-inbox', $classification_modal_css);
?>
