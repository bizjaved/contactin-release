...
<div class="tablenav <?php echo esc_attr( $which ); ?>">
    <div class="alignleft actions">
        <label for="method-filter" class="screen-reader-text">
            <?php esc_html_e( 'Filter by method', Config::TEXTDOMAIN ); ?>
        </label>
        <select id="method-filter" name="method">
            <option value="all" <?php selected( $current_method, 'all' ); ?>><?php esc_html_e( 'All Methods', Config::TEXTDOMAIN ); ?></option>
        ...
        <select id="endpoint-filter" name="endpoint">
            <option value="all" <?php selected( $current_endpoint, 'all' ); ?>><?php esc_html_e( 'All Endpoints', Config::TEXTDOMAIN ); ?></option>
        ...
        <select id="http-filter" name="http_code">
            <option value="all" <?php selected( $current_http_code, 'all' ); ?>><?php esc_html_e( 'All Codes', Config::TEXTDOMAIN ); ?></option>
        ...
        <label for="validated-filter" class="screen-reader-text">
            <?php esc_html_e( 'Filter by Validated', Config::TEXTDOMAIN ); ?>
        </label>
        <select id="validated-filter" name="validated">
            <option value="all" <?php selected( $current_validated, 'all' ); ?>><?php esc_html_e( 'All', Config::TEXTDOMAIN ); ?></option>
            <option value="1" <?php selected( $current_validated, '1' ); ?>><?php esc_html_e( '✔ Valid', Config::TEXTDOMAIN ); ?></option>
            <option value="0" <?php selected( $current_validated, '0' ); ?>><?php esc_html_e( '✖ Invalid', Config::TEXTDOMAIN ); ?></option>
        </select>
