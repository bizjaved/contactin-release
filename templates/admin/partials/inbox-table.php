...
if ( isset( $args ) && is_array( $args ) ) {
    ...
    $extra_query_args = isset( $args['extra_query_args'] ) && is_array( $args['extra_query_args'] ) ? $args['extra_query_args'] : [];
}
...
function ci_get_sortable_link( $column, $label, $orderby, $order, $search, $status, $per_page, array $extra_args = [] ) {
    ...
    $url = add_query_arg( array_merge( $extra_args, [
        'orderby'  => $column,
        'order'    => $new_order,
        's'        => $search,
        'status'   => $status,
