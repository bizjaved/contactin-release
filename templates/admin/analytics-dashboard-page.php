...
<div class="wrap contactin-dashboard-analytics">
    ...
    <div class="contactin-analytics-content">
        ...
        <!-- PERFORMANCE TAB -->
        <div class="tab-pane" id="performance-pane" data-tab="performance" <?php if ($is_expired_license_state): ?>aria-disabled="true"<?php endif; ?>>
            <div class="analytics-section">
        ...
        <!-- SALESFORCE CRM TAB -->
        <div class="tab-pane" id="crm-pane" data-tab="crm" <?php if ($is_expired_license_state): ?>aria-disabled="true"<?php endif; ?>>
            <div class="analytics-section">
        ...
        <!-- CRON TAB -->
        <div class="tab-pane" id="cron-pane" data-tab="cron" <?php if ($is_expired_license_state): ?>aria-disabled="true"<?php endif; ?>>
            <div class="analytics-section">
        ...
        <!-- USERS TAB -->
        <div class="tab-pane" id="users-pane" data-tab="users" <?php if ($is_expired_license_state): ?>aria-disabled="true"<?php endif; ?>>
            <div class="analytics-section">
