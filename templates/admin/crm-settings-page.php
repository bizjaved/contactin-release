			...
			<div class="warning-box">
				<p>
					...
					<table class="crm-mapping-table">
						...
						<tbody>
							<?php
							$plugin_fields = array( 'email', 'phone', 'subject', 'message', 'salutation', 'source', 'intent_category', 'intent_confidence' );
							$plugin_labels = array(
								'email'             => 'Email Address',
								'phone'             => 'Phone Number',
							...
							foreach ( $plugin_fields as $field ) :
								...
								$is_intent_field = in_array( $field, array( 'intent_category', 'intent_confidence' ), true );
								?>
								<tr>
