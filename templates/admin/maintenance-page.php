...
<div class="wrap contactin-maint-wrap">
    ...
    <div class="contactin-maint-grid">
        ...
        <div class="contactin-card <?php echo (defined('CONTACTINBOX_IS_FREE') && CONTACTINBOX_IS_FREE) ? 'contactin-card-disabled' : ''; ?>">
            ...
            <div class="contactin-actions">
                <button class="button button-primary <?php echo (defined('CONTACTINBOX_IS_FREE') && CONTACTINBOX_IS_FREE) ? 'contactinbox-show-upgrade-modal' : 'js-maint-action'; ?>" <?php echo (defined('CONTACTINBOX_IS_FREE') && CONTACTINBOX_IS_FREE) ? '' : 'data-action="contactin_maint_run_queue_crm" data-nonce="' . esc_attr($nonce_run_crm) . '"'; ?> title="<?php echo (defined('CONTACTINBOX_IS_FREE') && CONTACTINBOX_IS_FREE) ? esc_attr__('CRM Sync Processing is available in Contact Inbox Pro', Config::TEXTDOMAIN) : ''; ?>">
                ...
                <button class="button <?php echo (defined('CONTACTINBOX_IS_FREE') && CONTACTINBOX_IS_FREE) ? 'contactinbox-show-upgrade-modal' : 'js-maint-action'; ?>" <?php echo (defined('CONTACTINBOX_IS_FREE') && CONTACTINBOX_IS_FREE) ? '' : 'data-action="contactin_maint_reschedule_crm_queue" data-nonce="' . esc_attr($nonce_resched_crm) . '" data-delay-default="' . esc_attr($crm_reschedule_default) . '"'; ?> title="<?php echo (defined('CONTACTINBOX_IS_FREE') && CONTACTINBOX_IS_FREE) ? esc_attr__('Reschedule CRM Queue is available in Contact Inbox Pro', Config::TEXTDOMAIN) : ''; ?>">
        ...
        <div class="contactin-card <?php echo (defined('CONTACTINBOX_IS_FREE') && CONTACTINBOX_IS_FREE) ? 'contactin-card-disabled' : ''; ?>">
            ...
            <div class="contactin-actions">
                <button class="button button-primary <?php echo (defined('CONTACTINBOX_IS_FREE') && CONTACTINBOX_IS_FREE) ? 'contactinbox-show-upgrade-modal' : 'js-maint-action'; ?>" <?php echo (defined('CONTACTINBOX_IS_FREE') && CONTACTINBOX_IS_FREE) ? '' : 'data-action="contactin_maint_retry_crm_dlq" data-nonce="' . esc_attr($nonce_retry_crm) . '"'; ?> title="<?php echo (defined('CONTACTINBOX_IS_FREE') && CONTACTINBOX_IS_FREE) ? esc_attr__('Retry Failed CRM Syncs is available in Contact Inbox Pro', Config::TEXTDOMAIN) : ''; ?>">
        ...
        <div class="contactin-card <?php echo (defined('CONTACTINBOX_IS_FREE') && CONTACTINBOX_IS_FREE) ? 'contactin-card-disabled' : ''; ?>">
            ...
            <?php endif; ?>
            <div class="contactin-actions">
                <button class="button <?php echo (defined('CONTACTINBOX_IS_FREE') && CONTACTINBOX_IS_FREE) ? 'contactinbox-show-upgrade-modal' : (($synced_count === 0) ? 'disabled' : 'cin-gdpr-queue-delete-btn'); ?>" <?php echo (defined('CONTACTINBOX_IS_FREE') && CONTACTINBOX_IS_FREE) ? '' : 'data-nonce="' . esc_attr($nonce_gdpr_queue_delete) . '"'; ?> <?php if (!defined('CONTACTINBOX_IS_FREE') || !CONTACTINBOX_IS_FREE) disabled($synced_count === 0); ?> title="<?php echo (defined('CONTACTINBOX_IS_FREE') && CONTACTINBOX_IS_FREE) ? esc_attr__('Queue for Deletion is available in Contact Inbox Pro', Config::TEXTDOMAIN) : ''; ?>">
                    <?php esc_html_e('Queue for Deletion', Config::TEXTDOMAIN); ?>
                    <?php if ( defined('CONTACTINBOX_IS_FREE') && CONTACTINBOX_IS_FREE ) : ?>
                        <span style="margin-left: 4px; background: #dc3545; color: white; padding: 2px 6px; border-radius: 3px; font-size: 11px; font-weight: bold;">PRO</span>
                    <?php endif; ?>
                </button>
                <button class="button button-primary <?php echo (defined('CONTACTINBOX_IS_FREE') && CONTACTINBOX_IS_FREE) ? 'contactinbox-show-upgrade-modal' : (($synced_count === 0) ? 'disabled' : 'cin-gdpr-immediate-delete-btn'); ?>" <?php echo (defined('CONTACTINBOX_IS_FREE') && CONTACTINBOX_IS_FREE) ? '' : 'data-nonce="' . esc_attr($nonce_gdpr_immediate_delete) . '"'; ?> <?php if (!defined('CONTACTINBOX_IS_FREE') || !CONTACTINBOX_IS_FREE) disabled($synced_count === 0); ?> title="<?php echo (defined('CONTACTINBOX_IS_FREE') && CONTACTINBOX_IS_FREE) ? esc_attr__('Delete Now is available in Contact Inbox Pro', Config::TEXTDOMAIN) : ''; ?>">
                    <?php esc_html_e('Delete Now', Config::TEXTDOMAIN); ?>
                    <?php if ( defined('CONTACTINBOX_IS_FREE') && CONTACTINBOX_IS_FREE ) : ?>
                        <span style="margin-left: 4px; background: #dc3545; color: white; padding: 2px 6px; border-radius: 3px; font-size: 11px; font-weight: bold;">PRO</span>
                    <?php endif; ?>
                </button>
                <a href="<?php echo (defined('CONTACTINBOX_IS_FREE') && CONTACTINBOX_IS_FREE) ? '#' : esc_url(admin_url('admin.php?page=' . Config::MENU_GDPR_LOG)); ?>" class="button <?php echo (defined('CONTACTINBOX_IS_FREE') && CONTACTINBOX_IS_FREE) ? 'contactinbox-show-upgrade-modal' : ''; ?>" title="<?php echo (defined('CONTACTINBOX_IS_FREE') && CONTACTINBOX_IS_FREE) ? esc_attr__('View GDPR Log is available in Contact Inbox Pro', Config::TEXTDOMAIN) : ''; ?>">
