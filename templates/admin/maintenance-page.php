...
<div class="wrap contactin-maint-wrap">
    ...
    <div class="contactin-maint-grid">
        ...
        <div class="contactin-card">
            ...
            <?php endif; ?>
            <div class="contactin-actions">
                <button class="button <?php if ($synced_count === 0) echo 'disabled'; ?> cin-gdpr-queue-delete-btn" data-nonce="<?php echo esc_attr($nonce_gdpr_queue_delete); ?>" <?php disabled($synced_count === 0); ?>>
                    <?php esc_html_e('Queue for Deletion',  'contactin'); ?>
                </button>
                <button class="button button-primary <?php if ($synced_count === 0) echo 'disabled'; ?> cin-gdpr-immediate-delete-btn" data-nonce="<?php echo esc_attr($nonce_gdpr_immediate_delete); ?>" <?php disabled($synced_count === 0); ?>>
        ...
        <div class="contactin-card contactin-attachment-cleanup-card">
            ...
            <div class="contactin-attachment-actions cin-flex-column-gap">
                <button class="button button-primary" id="cin-attach-delete-btn" <?php if ($orph_count === 0) echo 'disabled'; ?>><?php esc_html_e('Clean Up Orphaned Files',  'contactin'); ?></button>
                <?php if ($attachment_stale['stale_count'] > 0): ?>
        ...
        <?php
        include CONTACTINBOX_PATH . Config::TEMPLATE_ADMIN_PART . 'intent-learning-widget.php';
        ?>
    </div>
