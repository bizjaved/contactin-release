	...
	<div class="integration-list">
		...
		<div class="integration-item">
			<div class="integration-header">
				<div class="integration-name">
					...
					<a href="<?php echo esc_url( add_query_arg( array( 'page' => 'contactin-crm' ), admin_url( 'admin.php' ) ) ); ?>" 
		...
		<div class="integration-item">
			<div class="integration-header">
				...
				<a href="<?php echo esc_url( add_query_arg( array( 'page' => 'contactin-settings' ), admin_url( 'admin.php' ) ) ); ?>" 
		...
		<div class="integration-item">
			<div class="integration-header">
				...
				<a href="<?php echo esc_url( add_query_arg( array( 'page' => 'contactin-restapi-integration' ), admin_url( 'admin.php' ) ) ); ?>" 
