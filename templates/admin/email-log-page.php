...
<div class="wrap cin-email-log-page">
    <div class="cin-page-header">
        <div>
            <h1><?php esc_html_e( 'Email Log', Config::TEXTDOMAIN ); ?></h1>
            <span class="cin-header-count">
                <?php printf(
                    _n( '(%s email log)', '(%s email logs)', $total_items, Config::TEXTDOMAIN ),
    ...
    <form id="contactin-email-log-form" method="get">
        ...
        <div class="tablenav top cin-log-tablenav-pages cin-email-log-tablenav-pages">
            <div class="tablenav-pages">
                ...
                <!-- Per page filter -->
                <label for="per-page-filter-email" class="cin-per-page-label"><?php esc_html_e( 'Rows per page', Config::TEXTDOMAIN ); ?></label>
