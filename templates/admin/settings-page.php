...
<div class="wrap">
	...
	<div class="cin-settings-header-wrapper">
		<h1 class="cin-settings-title"><?php esc_html_e( 'Settings', 'contactin' ); ?></h1>
	...
	<form id="contactin-settings-form" method="post">
		...
		<div class="cin-settings-search-box">
			...
			<input type="search" id="cin-settings-search" class="cin-settings-search-input" placeholder="<?php esc_html_e( 'Search settings by name or keyword...', 'contactin' ); ?>" aria-label="<?php esc_attr_e( 'Search settings', 'contactin' ); ?>" />
			<span id="cin-search-results" class="cin-hidden cin-settings-search-results"><?php esc_html_e( 'No matches', 'contactin' ); ?></span>
		...
		<div class="nav-tab-wrapper">
			<a href="#cin-tab-general" class="nav-tab nav-tab-active" data-tab="general"><?php esc_html_e( 'General', 'contactin' ); ?></a>
			<a href="#cin-tab-security" class="nav-tab" data-tab="security"><?php esc_html_e( 'Security', 'contactin' ); ?></a>
			<a href="#cin-tab-smtp" class="nav-tab" data-tab="smtp">SMTP</a>
			<a href="#cin-tab-notifications" class="nav-tab" data-tab="notifications"><?php esc_html_e( 'Notifications', 'contactin' ); ?></a>
			<a href="#cin-tab-form" class="nav-tab" data-tab="form"><?php esc_html_e( 'Form', 'contactin' ); ?></a>
			<a href="#cin-tab-forms" class="nav-tab" data-tab="forms"><?php esc_html_e( 'Form Profiles', 'contactin' ); ?></a>
			<a href="#cin-tab-advanced" class="nav-tab" data-tab="advanced"><?php esc_html_e( 'Advanced', 'contactin' ); ?></a>
			<a href="#cin-tab-ai-classifier" class="nav-tab" data-tab="ai-classifier">🤖 <?php esc_html_e( 'AI Classifier', 'contactin' ); ?></a>
		</div>
		...
		<div id="cin-tab-general" class="cin-tab-content is-active">
			...
			<table class="form-table" role="presentation">
				<tr>
					<th scope="row"><label for="privacy_url"><?php esc_html_e( 'Privacy Policy URL', 'contactin' ); ?></label></th>
				...
				<tr>
					<th scope="row"><label for="consent_text"><?php esc_html_e( 'Consent Text', 'contactin' ); ?></label></th>
				...
				<tr>
					<th scope="row"><label for="success_message"><?php esc_html_e( 'Success Message', 'contactin' ); ?></label></th>
				...
				<tr>
					<th scope="row"><?php esc_html_e( 'Confetti on Success', 'contactin' ); ?></th>
					<td>
						<fieldset>
							<legend class="screen-reader-text"><span><?php esc_html_e( 'Confetti on Success', 'contactin' ); ?></span></legend>
							...
							<div class="cin-flex-center-gap">
								...
								<label for="confetti-enable-checkbox" class="cin-cursor-pointer cin-m-0"><?php esc_html_e( 'Show confetti animation', 'contactin' ); ?></label>
							</div>
		...
		<div id="cin-tab-security" class="cin-tab-content">
			<h3><?php esc_html_e( 'Security Settings', 'contactin' ); ?></h3>

			<h4><?php esc_html_e( 'reCAPTCHA v3', 'contactin' ); ?></h4>
			<table class="form-table" role="presentation">
				<tr>
					<th scope="row"><label for="recaptcha_site_key"><?php esc_html_e( 'Site Key', 'contactin' ); ?></label></th>
				...
				<tr>
					<th scope="row"><label for="recaptcha_secret_key"><?php esc_html_e( 'Secret Key', 'contactin' ); ?></label></th>
				...
				<tr>
					<th scope="row"><?php esc_html_e( 'Enable reCAPTCHA', 'contactin' ); ?></th>
					<td>
						<fieldset>
							<legend class="screen-reader-text"><span><?php esc_html_e( 'Enable reCAPTCHA', 'contactin' ); ?></span></legend>
							<input type="hidden" name="recaptcha_enable" value="0" />
							<label><input name="recaptcha_enable" type="checkbox" value="1" <?php checked( ! empty( $settings['recaptcha_enable'] ) ); ?> data-search="enable recaptcha" /> <?php esc_html_e( 'Enable', 'contactin' ); ?></label>
						</fieldset>
					</td>
				</tr>
			</table>

			<h4 style="margin-top: 24px;"><?php esc_html_e( 'Rate Limiting', 'contactin' ); ?></h4>
			<table class="form-table" role="presentation">
				<tr>
					<th scope="row"><label for="rate_limit_per_minute"><?php esc_html_e( 'Requests Per Minute', 'contactin' ); ?></label></th>
					<td>
						...
						<p class="description"><?php printf( esc_html__( 'Recommended: %d', 'contactin' ), (int) ( $defaults['rate_limit_per_minute'] ?? Config::RATE_LIMIT_PER_MINUTE ) ); ?></p>
					</td>
				</tr>
				<tr>
					<th scope="row"><label for="rate_limit_per_hour"><?php esc_html_e( 'Requests Per Hour', 'contactin' ); ?></label></th>
					<td>
						...
						<p class="description"><?php printf( esc_html__( 'Recommended: %d', 'contactin' ), (int) ( $defaults['rate_limit_per_hour'] ?? Config::RATE_LIMIT_PER_HOUR ) ); ?></p>
					</td>
				</tr>
				<tr>
					<th scope="row"><label for="rate_limit_per_day"><?php esc_html_e( 'Requests Per Day', 'contactin' ); ?></label></th>
					<td>
						...
						<p class="description"><?php printf( esc_html__( 'Recommended: %d', 'contactin' ), (int) ( $defaults['rate_limit_per_day'] ?? Config::RATE_LIMIT_PER_DAY ) ); ?></p>
					</td>
				</tr>
			</table>

			<h4 style="margin-top: 24px;"><?php esc_html_e( 'IP Controls', 'contactin' ); ?></h4>
			<table class="form-table" role="presentation">
				<tr>
					<th scope="row"><?php esc_html_e( 'Enable Allowlist Mode', 'contactin' ); ?></th>
					<td>
						<fieldset>
							<legend class="screen-reader-text"><span><?php esc_html_e( 'Enable Allowlist Mode', 'contactin' ); ?></span></legend>
							<input type="hidden" name="ip_allowlist_enable" value="0" />
							<label><input name="ip_allowlist_enable" type="checkbox" value="1" <?php checked( ! empty( $settings['ip_allowlist_enable'] ) ); ?> data-search="ip allowlist security" /> <?php esc_html_e( 'Only allow listed IP addresses', 'contactin' ); ?></label>
						</fieldset>
					</td>
				</tr>
				<tr>
					<th scope="row"><label for="ip_allowlist"><?php esc_html_e( 'IP Allowlist', 'contactin' ); ?></label></th>
					<td>
						...
						<p class="description"><?php esc_html_e( 'Enter one IP per line (IPv4/IPv6). When allowlist mode is enabled, only these IPs can submit.', 'contactin' ); ?></p>
					</td>
				</tr>
				<tr>
					<th scope="row"><label for="ip_blacklist"><?php esc_html_e( 'IP Blocklist', 'contactin' ); ?></label></th>
					<td>
						...
						<p class="description"><?php esc_html_e( 'Enter one IP per line (IPv4/IPv6). Listed IPs are always blocked.', 'contactin' ); ?></p>
					</td>
				</tr>
			</table>
		</div>
		...
		<div id="cin-tab-smtp" class="cin-tab-content">
			...
			<table class="form-table" role="presentation">
				<tr>
					<th scope="row"><label for="smtp-enable-btn"><?php esc_html_e( 'Enable SMTP', 'contactin' ); ?></label></th>
					<td>
						...
						<span class="description"><?php esc_html_e( 'Send emails via SMTP instead of WordPress default mail.', 'contactin' ); ?></span>
					</td>
				</tr>
				<tr class="smtp-dependent-field">
					<th scope="row"><label for="smtp_host"><?php esc_html_e( 'Host', 'contactin' ); ?></label></th>
				...
				<tr class="smtp-dependent-field">
					<th scope="row"><label for="smtp_port"><?php esc_html_e( 'Port', 'contactin' ); ?></label></th>
				...
				<tr class="smtp-dependent-field">
					<th scope="row"><label for="smtp_encryption"><?php esc_html_e( 'Encryption', 'contactin' ); ?></label></th>
					<td>
						<select name="smtp_encryption" id="smtp_encryption"  data-search="smtp encryption" <?php disabled( empty( $settings['smtp_enable'] ) ); ?>>
							<option value="none" <?php selected( $settings['smtp_encryption'] ?? '', 'none' ); ?>><?php esc_html_e( 'None', 'contactin' ); ?></option>
				...
				<tr class="smtp-dependent-field">
					<th scope="row"><label for="smtp_user"><?php esc_html_e( 'Username', 'contactin' ); ?></label></th>
				...
				<tr class="smtp-dependent-field">
					<th scope="row"><label for="smtp_pass"><?php esc_html_e( 'Password', 'contactin' ); ?></label></th>
					<td>
						<input name="smtp_pass" type="password" id="smtp_pass" value="" class="large-text"  
							placeholder="<?php echo ! empty( $settings['smtp_pass'] ) ? esc_attr( esc_html__( 'Existing password set (leave blank to keep)', 'contactin' ) ) : esc_attr( esc_html__( 'Enter SMTP password', 'contactin' ) ); ?>" 
						...
						<p class="description">
							...
							if ( ! empty( $settings['smtp_pass'] ) ) {
								esc_html_e( 'Password is already saved. Leave blank to keep existing password, or enter a new one to change it.', 'contactin' );
							} else {
								esc_html_e( 'Enter the SMTP password for authentication.', 'contactin' );
							}
							?>
						</p>
					</td>
				...
				<tr class="smtp-dependent-field">
					<th scope="row"><label for="smtp_from_email"><?php esc_html_e( 'Sender Email Address', 'contactin' ); ?></label></th>
					<td>
						...
						<p class="description">
							<?php esc_html_e( 'Must be a mailbox you own on the authenticated SMTP domain. This becomes the visible From address.', 'contactin' ); ?>
						</p>
					</td>
				</tr>
				<tr class="smtp-dependent-field">
					<th scope="row"><label for="smtp_from_name"><?php esc_html_e( 'Sender Name', 'contactin' ); ?></label></th>
					<td>
						...
						<p class="description">
							<?php esc_html_e( 'Shown alongside the sender email. Defaults to the site name if left blank.', 'contactin' ); ?>
						</p>
					</td>
				</tr>
			</table>
		...
		<div id="cin-tab-notifications" class="cin-tab-content">
			...
			<table class="form-table" role="presentation">
				<tr class="smtp-notification-field">
					<th scope="row"><?php esc_html_e( 'Send Form Submission to Admin', 'contactin' ); ?></th>
					<td>
						<fieldset>
				...
				<tr class="smtp-notification-field">
					<th scope="row"><label for="admin_email"><?php esc_html_e( 'Admin Email(s)', 'contactin' ); ?></label></th>
					<td>
				...
				<tr class="smtp-notification-field">
					<th scope="row"><?php esc_html_e( 'Send Copy to User', 'contactin' ); ?></th>
					<td>
						<fieldset>
		...
		<div id="cin-tab-form" class="cin-tab-content">
			<h3><?php esc_html_e( 'Global Form Settings', 'contactin' ); ?></h3>
			<p class="description" style="margin-bottom:16px;font-size:13px;"><?php esc_html_e( 'These settings apply globally to every contact form on this site. Security-critical options (such as file uploads) cannot be overridden at the Form Profile level — they act as a site-wide lock.', 'contactin' ); ?></p>

			<table class="form-table" role="presentation">
				<tr>
					<th scope="row"><label for="form-enable-subject-btn"><?php esc_html_e( 'Subject Field', 'contactin' ); ?></label></th>
					<td>
						...
						<span class="description"><?php esc_html_e( 'Allow users to enter a subject.', 'contactin' ); ?></span>
					</td>
				</tr>

				<tr>
					<th scope="row"><label for="form_require_subject"><?php esc_html_e( 'Require Subject', 'contactin' ); ?></label></th>
					<td>
						<label>
							...
							<?php esc_html_e( 'Make the Subject field mandatory', 'contactin' ); ?>
						</label>
						<p class="description"><?php esc_html_e( 'Only applies when the Subject field is enabled. Individual Form Profiles can override this.', 'contactin' ); ?></p>
					</td>
				</tr>

				<tr>
					<th scope="row"><label for="form_require_phone"><?php esc_html_e( 'Require Phone', 'contactin' ); ?></label></th>
					<td>
						<label>
							...
							<?php esc_html_e( 'Make the Phone field mandatory', 'contactin' ); ?>
						</label>
						<p class="description"><?php esc_html_e( 'Individual Form Profiles can override this per form.', 'contactin' ); ?></p>
					</td>
				</tr>

				<tr>
					<th scope="row"><label for="form-enable-salutation-btn"><?php esc_html_e( 'Salutation Field', 'contactin' ); ?></label></th>
					<td>
						...
						<span class="description"><?php esc_html_e( 'Allow users to select a salutation (Mr/Ms/Mrs/Dr/etc.).', 'contactin' ); ?></span>
					</td>
				</tr>

				<tr>
					<th scope="row"><label for="form-enable-attachment-btn"><?php esc_html_e( 'File Attachment', 'contactin' ); ?></label></th>
					<td>
						...
						<p class="description" style="margin-top:6px;"><?php esc_html_e( 'Globally enable or disable file uploads across all contact forms.', 'contactin' ); ?><br>
						<strong><?php esc_html_e( 'When disabled here, no Form Profile or shortcode can override it.', 'contactin' ); ?></strong> <?php esc_html_e( 'This is a hard security lock — use it intentionally.', 'contactin' ); ?></p>
					</td>
				</tr>

				<tr>
					<th scope="row"><label for="max_name_chars"><?php esc_html_e( 'Name Field Length (Max Chars)', 'contactin' ); ?></label></th>
					<td>
				...
				<tr>
					<th scope="row"><label for="min_name_words"><?php esc_html_e( 'Name Field Min Words', 'contactin' ); ?></label></th>
					<td>
				...
				<tr>
					<th scope="row"><label for="max_subject_chars"><?php esc_html_e( 'Subject Field Length (Max Chars)', 'contactin' ); ?></label></th>
					<td>
				...
				<tr>
					<th scope="row"><label for="min_subject_words"><?php esc_html_e( 'Subject Field Min Words', 'contactin' ); ?></label></th>
					<td>
				...
				<tr>
					<th scope="row"><label for="max_message_chars"><?php esc_html_e( 'Message Field Length (Max Chars)', 'contactin' ); ?></label></th>
					<td>
				...
				<tr>
					<th scope="row"><label for="min_message_words"><?php esc_html_e( 'Message Field Min Words', 'contactin' ); ?></label></th>
					<td>
				...
				<tr>
					<th scope="row"><label for="max_file_size"><?php esc_html_e( 'Max File Size (MB)', 'contactin' ); ?></label></th>
					<td>
		...
		<div id="cin-tab-forms" class="cin-tab-content">
			<h3><?php esc_html_e( 'Form Profiles', 'contactin' ); ?></h3>
			<p class="description"><?php esc_html_e( 'Create named form configurations. Assign a profile to any block or shortcode using the Form Profile selector. All submissions from every profile still land in the same inbox.', 'contactin' ); ?></p>

			<div id="cin-profiles-wrap" style="margin-top:18px;">
				<table class="widefat striped" id="cin-profiles-table">
					<thead>
						<tr>
							<th style="width:140px"><?php esc_html_e( 'Slug', 'contactin' ); ?></th>
							<th><?php esc_html_e( 'Label', 'contactin' ); ?></th>
							<th style="width:80px"><?php esc_html_e( 'Phone', 'contactin' ); ?></th>
							<th style="width:80px"><?php esc_html_e( 'Subject', 'contactin' ); ?></th>
							<th style="width:80px"><?php esc_html_e( 'Consent', 'contactin' ); ?></th>
							<th style="width:110px"><?php esc_html_e( 'Notify Email', 'contactin' ); ?></th>
							<th style="width:120px"></th>
						</tr>
					</thead>
					<tbody id="cin-profiles-tbody">
						<tr><td colspan="7" style="text-align:center;padding:20px;"><?php esc_html_e( 'Loading…', 'contactin' ); ?></td></tr>
					</tbody>
				</table>
				<p style="margin-top:12px;">
					<button type="button" class="button button-primary" id="cin-add-profile-btn" style="position:relative;z-index:200;pointer-events:auto;"><?php esc_html_e( '+ New Profile', 'contactin' ); ?></button>
				</p>
			</div>
			...
			<div id="cin-profile-modal" class="cin-modal cin-modal-hidden" role="dialog" aria-modal="true" aria-labelledby="cin-editor-title">
				...
				<div class="cin-modal-content" style="max-width:680px;">
					<div class="cin-modal-header">
						<h2 class="cin-modal-title" id="cin-editor-title"><?php esc_html_e( 'New Profile', 'contactin' ); ?></h2>
				...
				<table class="form-table" role="presentation" style="margin-top:0;">
					<tr>
						<th><label for="cin-p-label"><?php esc_html_e( 'Profile Name', 'contactin' ); ?></label></th>
						<td><input type="text" id="cin-p-label" class="regular-text" placeholder="<?php esc_attr_e( 'e.g. Support Form', 'contactin' ); ?>" /></td>
					</tr>
					<tr id="cin-slug-row">
						<th><label for="cin-p-slug"><?php esc_html_e( 'Slug', 'contactin' ); ?></label></th>
						<td>
							<span id="cin-slug-display">
								...
								<a href="#" id="cin-slug-edit-link" style="margin-left:8px;font-size:12px;"><?php esc_html_e( 'Edit', 'contactin' ); ?></a>
							</span>
							<span id="cin-slug-input-wrap" style="display:none;">
								...
								<a href="#" id="cin-slug-auto-link" style="margin-left:8px;font-size:12px;"><?php esc_html_e( 'Auto-generate', 'contactin' ); ?></a>
								<span id="cin-slug-error" style="color:#dc3232;margin-left:8px;font-size:12px;display:none;"></span>
							</span>
							<p class="description" id="cin-slug-desc-new"><?php esc_html_e( 'Auto-generated from profile name. Lowercase letters, numbers, hyphens, underscores. Cannot be changed after creation.', 'contactin' ); ?></p>
							<p class="description" id="cin-slug-desc-edit" style="display:none;"><?php esc_html_e( 'Slug cannot be changed after creation.', 'contactin' ); ?></p>
						</td>
					</tr>
					<tr>
						<th><?php esc_html_e( 'Fields', 'contactin' ); ?></th>
						<td>
							<label><input type="checkbox" id="cin-p-show-phone" checked /> <?php esc_html_e( 'Show Phone field', 'contactin' ); ?></label><br>
							<label><input type="checkbox" id="cin-p-require-phone" /> <?php esc_html_e( 'Require Phone', 'contactin' ); ?></label><br>
							<label><input type="checkbox" id="cin-p-show-salutation" /> <?php esc_html_e( 'Show Salutation', 'contactin' ); ?></label><br>
							<label><input type="checkbox" id="cin-p-show-subject" /> <?php esc_html_e( 'Show Subject line', 'contactin' ); ?></label><br>
							<label><input type="checkbox" id="cin-p-require-subject" /> <?php esc_html_e( 'Require Subject', 'contactin' ); ?></label><br>
							<label><input type="checkbox" id="cin-p-show-consent" checked /> <?php esc_html_e( 'Show Consent checkbox', 'contactin' ); ?></label>
						</td>
					</tr>
					<tr>
						<th><label for="cin-p-recaptcha"><?php esc_html_e( 'reCAPTCHA', 'contactin' ); ?></label></th>
						<td>
							<select id="cin-p-recaptcha">
								<option value="auto"><?php esc_html_e( 'Auto (follow global setting)', 'contactin' ); ?></option>
								<option value="on"><?php esc_html_e( 'Force On', 'contactin' ); ?></option>
								<option value="off"><?php esc_html_e( 'Force Off', 'contactin' ); ?></option>
							</select>
						</td>
					</tr>
					<tr>
						<th><label for="cin-p-confetti"><?php esc_html_e( 'Confetti', 'contactin' ); ?></label></th>
						<td>
					...
					<tr>
						<th><label for="cin-p-notify-email"><?php esc_html_e( 'Notification Email', 'contactin' ); ?></label></th>
						<td>
					...
					<tr>
						<th><label for="cin-p-success-message"><?php esc_html_e( 'Success Message', 'contactin' ); ?></label></th>
						<td>
							<input type="text" id="cin-p-success-message" class="large-text" placeholder="<?php esc_html_e( 'Leave empty to use global success message', 'contactin' ); ?>" />
						</td>
					</tr>
					<tr>
						<th><label for="cin-p-consent-text"><?php esc_html_e( 'Consent Text', 'contactin' ); ?></label></th>
						<td>
							<textarea id="cin-p-consent-text" class="large-text" rows="2" placeholder="<?php esc_html_e( 'Leave empty to use global consent text', 'contactin' ); ?>"></textarea>
						</td>
					</tr>
				</table>
					</div><!-- /cin-modal-body -->
					...
					<div class="cin-modal-footer" style="padding:16px 20px;border-top:1px solid #ddd;display:flex;align-items:center;gap:8px;flex-shrink:0;">
						<button type="button" class="button button-primary" id="cin-save-profile-btn"><?php esc_html_e( 'Save Profile', 'contactin' ); ?></button>
						<button type="button" class="button" id="cin-cancel-profile-btn"><?php esc_html_e( 'Cancel', 'contactin' ); ?></button>
		...
		<div id="cin-tab-advanced" class="cin-tab-content">
			<h3><?php esc_html_e( 'Advanced Settings', 'contactin' ); ?></h3>

			<table class="form-table" role="presentation">
				<tr>
					<th scope="row"><label for="email_log_retention_days"><?php esc_html_e( 'Email Log Retention (days)', 'contactin' ); ?></label></th>
					<td>
						...
						<p class="description"><?php esc_html_e( 'Number of days to keep email logs before automatic cleanup.', 'contactin' ); ?></p>
					</td>
				</tr>
				<tr>
					<th scope="row"><label for="gdpr_log_retention_days"><?php esc_html_e( 'GDPR Log Retention (days)', 'contactin' ); ?></label></th>
					<td>
						...
						<p class="description"><?php esc_html_e( 'Number of days to keep GDPR deletion logs before pruning.', 'contactin' ); ?></p>
					</td>
				</tr>
			</table>
			...
			$allowed_intervals = array(
				'contactin_one_minute'      => esc_html__( 'Every 1 minute', 'contactin' ),
				'contactin_two_minutes'     => esc_html__( 'Every 2 minutes', 'contactin' ),
				'contactin_five_minutes'    => esc_html__( 'Every 5 minutes', 'contactin' ),
				'contactin_fifteen_minutes' => esc_html__( 'Every 15 minutes', 'contactin' ),
				'hourly'                    => esc_html__( 'Hourly', 'contactin' ),
			);
			?>

			<h4 style="margin-top:24px;">&raquo; <?php esc_html_e( 'Background Job Scheduling', 'contactin' ); ?></h4>
			<p class="description" style="margin-bottom:10px;">
				<?php esc_html_e( 'Adjust how often the email queue processor runs. Use Dashboard → Background Jobs to monitor executions and health.', 'contactin' ); ?>
			</p>

			<table class="wp-list-table widefat fixed striped" style="margin-top: 10px;">
				<thead>
					<tr>
						<th style="width: 30%;"><?php esc_html_e( 'Job', 'contactin' ); ?></th>
						<th style="width: 30%;"><?php esc_html_e( 'Schedule', 'contactin' ); ?></th>
						<th style="width: 25%;"><?php esc_html_e( 'Next Run', 'contactin' ); ?></th>
						<th style="width: 15%;"><?php esc_html_e( 'Actions', 'contactin' ); ?></th>
					</tr>
				</thead>
				<tbody>
					<tr>
						<td><strong><?php esc_html_e( 'Email Processor', 'contactin' ); ?></strong><br><small><?php echo esc_html( $queue_event_email ); ?></small></td>
						<td>
						...
						<td><?php echo $queue_next_run_email ? date_i18n( 'Y-m-d H:i:s', $queue_next_run_email ) : esc_html__( 'Not scheduled', 'contactin' ); ?></td>
						<td>
							<button type="button" class="button button-small run-cron-now" data-event="<?php echo esc_attr( $queue_event_email ); ?>"><?php esc_html_e( 'Run Now', 'contactin' ); ?></button>
						</td>
					</tr>
				</tbody>
			</table>
			...
			<div class="notice notice-warning inline" style="margin:12px 0;">
				<p>
					<?php esc_html_e( 'Running jobs more frequently than every 15 minutes can add load. Form submissions already trigger immediate one-off runs to avoid notification delays, so 15 minutes is recommended for the recurring schedule.', 'contactin' ); ?>
				</p>
			</div>

			<div class="notice notice-info inline" style="margin:12px 0;">
				<p>
					<?php esc_html_e( 'Background Jobs monitoring lives in Dashboard → Background Jobs.', 'contactin' ); ?>
					<a href="<?php echo esc_url( admin_url( 'admin.php?page=contactin-analytics#tab-cron' ) ); ?>"><?php esc_html_e( 'Open Background Jobs', 'contactin' ); ?></a>
				</p>
			</div>
		</div>
		...
		<div id="cin-tab-ai-classifier" class="cin-tab-content">
			<h3><?php esc_html_e( 'AI Intent Classifier', 'contactin' ); ?></h3>
			<p class="description">
				<?php esc_html_e( 'Configure automatic message classification and intent detection using business-specific keywords.', 'contactin' ); ?>
			</p>
		...
		<div class="cin-settings-save-wrapper" style="margin-top: 30px; padding-top: 15px; border-top: 1px solid #ccc; position: relative; z-index: 1001;">
			<button type="submit" id="contactin-save-button" class="button button-primary" data-state="default">
				<span class="cin-btn-text"><?php esc_html_e( 'Save Settings', 'contactin' ); ?></span>
				...
				<span class="cin-btn-saved" style="display:none;margin-left:6px;">✓ <?php esc_html_e( 'Saved', 'contactin' ); ?></span>
			</button>
		</div>
	</form>
