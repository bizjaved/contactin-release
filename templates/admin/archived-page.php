...
<div class="wrap cin-inbox-page">
	<div class="cin-page-header">
		<div>
			<h1><?php esc_html_e( 'Archived', 'contactin' ); ?></h1>
			<span class="cin-header-count">
			<?php
			printf(
				esc_html__( '(%s archived messages)', 'contactin' ),
		...
		<div>
			...
			<button type="button" class="button button-secondary" id="cin-clear-archives"
				...
				<?php esc_html_e( 'Clear All Archives', 'contactin' ); ?>
			</button>
		</div>
	</div>
	...
	<div class="cin-inbox-shell cin-px-md">
		<form method="get" id="messages-filter" class="cin-inbox-form">
			<input type="hidden" name="page" value="<?php echo esc_attr( Config::MENU_ARCHIVED ); ?>">
			...
			<div class="tablenav top cin-inbox-tablenav">
				<div class="alignleft actions">
					...
					<select name="action" id="bulk-action-selector-top" class="cin-bulk-action">
						...
						<option value="unarchive"><?php esc_html_e( 'Unarchive (Move to Inbox)', 'contactin' ); ?></option>
