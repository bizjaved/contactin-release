...
$attachment_enabled = $instance_override && \ContactInbox\Integration\FreemiusIntegration::can_use_premium_features();
  ...
  <form id="contactin-form" class="cin-contact-form" enctype="multipart/form-data">
    ...
    <div class="cin-field">
      <label>
        ...
        <?php if ( $phone_required ) : ?><span class="required">*</span><?php endif; ?>
      </label>
    ...
    <div class="cin-field">
      <label>
        ...
        <?php if ( $require_subject_flag ) : ?><span class="required">*</span><?php endif; ?>
      </label>
