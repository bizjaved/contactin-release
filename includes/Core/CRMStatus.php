...
final class CRMStatus
{
    ...
    {
        return [
            ['value' => 'all', 'label' => __('All Statuses',  'contactin')],
            ['value' => self::DELIVERED, 'label' => __('Delivered',  'contactin')],
            ['value' => self::PENDING, 'label' => __('Pending',  'contactin')],
            ['value' => self::FAILED, 'label' => __('Failed',  'contactin')],
            ['value' => self::REJECTED, 'label' => __('Rejected',  'contactin')],
            ['value' => self::SERVER_ERROR, 'label' => __('Server Error',  'contactin')],
            ['value' => self::CONNECTION_FAILED, 'label' => __('Connection Failed',  'contactin')],
            ['value' => self::INVALID_TOKEN, 'label' => __('Invalid Token',  'contactin')],
            ['value' => self::RATE_LIMITED, 'label' => __('Rate Limited',  'contactin')],
            ['value' => self::TIMEOUT, 'label' => __('Timeout',  'contactin')],
        ];
    }
    ...
    public static function label(?string $status): string
    {
        $normalized = self::normalize($status);
        switch ($normalized) {
            case self::DELIVERED:         return __('Delivered',  'contactin');
            case self::PENDING:           return __('Pending',  'contactin');
            case self::FAILED:            return __('Failed',  'contactin');
            case self::REJECTED:          return __('Rejected',  'contactin');
            case self::SERVER_ERROR:      return __('Server Error',  'contactin');
            case self::CONNECTION_FAILED: return __('Connection Failed',  'contactin');
            case self::INVALID_TOKEN:     return __('Invalid Token',  'contactin');
            case self::RATE_LIMITED:      return __('Rate Limited',  'contactin');
            case self::TIMEOUT:           return __('Timeout',  'contactin');
            default:                      return ucfirst($normalized);
        }
    }
}
