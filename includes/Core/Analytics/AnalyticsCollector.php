...
final class AnalyticsCollector {
	 ...
	 */
	public static function track_form_view( string $form_id, array $event_data = array() ): void {
		try {
	 ...
	 * @param array  $event_data Optional additional event data
	 */
	public static function track_form_submission( string $form_id, ?int $submission_id = null, array $event_data = array() ): void {
		try {
	 ...
	 * @param array  $event_data Optional additional event data
	 */
	public static function track_form_conversion( string $form_id, int $submission_id, array $event_data = array() ): void {
		try {
	...
	private static function store_event(
		...
		if ( $result === false ) {
			Logger::error( 'Analytics event insert failed', array( 'error' => $wpdb->last_error ) );
		}
