...
class ConcurrencyManager {
    ...
    public static function acquire_lock(string $lock_key, int $timeout = self::LOCK_TIMEOUT): string {
        try {
            ...
            $expires = current_time('timestamp') + $timeout;
    ...
    public static function lock_table(): bool {
        try {
            ...
            Logger::error('Failed to lock table', [
                'error' => $e->getMessage(),
            ]);
            return false;
        }
    ...
    public static function unlock_table(): bool {
        try {
            ...
            Logger::error('Failed to unlock table', [
                'error' => $e->getMessage(),
            ]);
            return false;
        }
    ...
    public static function get_stats(): array {
        try {
            ...
            Logger::error('Failed to get concurrency stats', [
                'error' => $e->getMessage(),
            ]);
            return [];
        }
