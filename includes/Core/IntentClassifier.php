        ...
        return [
            ...
            self::CATEGORY_SUPPORT => [
                ...
                'medium' => [
                    ...
                    // Resolution terms
                    'resolve', 'resolve', 'solution', 'fix it', 'work again', 'correct', 'rectify',
                    // Warranty/guarantee
                    'after sales', 'after-sales', 'warranty', 'guarantee', 'guarantee', 'coverage', 'protection plan',
            ...
            self::CATEGORY_COMPLAINT => [
                'high' => [
                    ...
                    'complaint', 'complain', 'unhappy', 'disappointed', 'frustrat', 'frustrated',
