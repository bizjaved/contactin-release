	...
	public static function get_patterns(): array {
		...
		$base['support']['high'] = array_merge(
			...
			array(
				...
				'consular service issue',
				'emergency travel document',
				'lost passport abroad',
				'document attestation delayed',
				...
				'courier tracking issue',
				'wrong details in passport',
				'name correction request',
				'urgent travel due to emergency',
				'consular emergency line',
			)
		);
		...
		$base['feedback']['high'] = array_merge(
			...
			array(
				...
				'improve queue discipline',
				'friendlier counter service',
				'better multilingual support',
				'clearer document checklist',
				'better emergency response support',
				'real-time status notifications',
				'better call center response',
			)
		);
		...
		$base['feedback']['medium'] = array_merge(
			...
			array(
				...
				'better holiday notices',
				'clear fee table',
				'better waiting area facilities',
			)
		);
		...
		$base['complaint']['high'] = array_merge(
			...
			array(
				...
				'visa refusal without clarity',
				'poor service at counter',
				'mishandled documents',
				'lost submitted documents',
				'wrongful rejection',
				'discriminatory treatment',
				'harassment at counter',
				'appointment system unfair',
				'bribery demand',
				'corruption complaint',
				'privacy breach of applicant data',
				'passport error caused travel loss',
			)
		);
		...
		$base['complaint']['medium'] = array_merge(
			...
			array(
				'no callback from embassy',
				'helpline unreachable',
				'email unanswered',
				'unclear instructions',
				'conflicting information',
				'long wait in queue',
				'repeated visit required',
				'counter closed unexpectedly',
				'poor communication',
			)
		);
		...
		$base['question']['high'] = array_merge(
			...
			array(
				...
				'how to renew passport abroad',
				'how to attest documents',
				'how long attestation takes',
				'how to apply emergency passport',
			)
		);
		...
		$base['question']['medium'] = array_merge(
			...
			array(
				...
				'how to authorize representative pickup',
			)
		);
		...
		$base['spam']['high'] = array_merge(
			...
			array(
				'guaranteed embassy visa',
				'instant visa approval guaranteed',
				'pay bribe for visa',
				'priority visa through contact',
				'fake embassy appointment link',
				'embassy payment scam',
				'share passport details now',
				'share otp for visa processing',
				'phishing consular portal',
				'fake high commission call',
			)
		);
