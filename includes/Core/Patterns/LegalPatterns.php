	...
	public static function get_patterns(): array {
		...
		$base['support']['medium'] = array_merge(
			...
			array(
				...
				'need copy of filed documents',
				'need signed copy',
				'change authorized contact',
		...
		$base['feedback']['high'] = array_merge(
			...
			array(
				'clearer legal explanation',
				'better case communication',
				'faster turnaround on drafts',
				'improve response time',
				'more transparent fee breakdown',
				'better client portal access',
				'proactive updates on milestones',
				'better hearing preparation guidance',
			)
		);
		...
		$base['complaint']['high'] = array_merge(
			...
			array(
				...
				'privileged information leaked',
				'missed court deadline',
				'poor representation in court',
				'overbilling legal fees',
				'hidden legal charges',
		...
		$base['complaint']['medium'] = array_merge(
			...
			array(
				'slow legal response',
				'draft quality poor',
				'case handling unsatisfactory',
				'support staff unhelpful',
				'unclear billing entries',
				'appointment delays',
			)
		);
		...
		$base['question']['high'] = array_merge(
			...
			array(
				'what documents needed for case',
				'what are legal fees',
				'how long will case take',
				'what are chances of success',
				'how to file legal notice',
				'how to file case',
				'can you represent in court',
				'what is consultation fee',
				'is online consultation available',
				'what is next hearing date process',
			)
		);
		...
		$base['question']['medium'] = array_merge(
			...
			array(
				...
				'can i get legal opinion in writing',
				'what is refund policy for retainers',
		...
		$base['spam']['high'] = array_merge(
			...
			array(
				'guaranteed court win',
				'100 percent win guarantee',
				'fake legal notice payment link',
				'pay now to avoid arrest scam',
				'impersonating lawyer office',
				'bar registration fraud',
				'share id and otp for case filing',
				'phishing legal portal link',
			)
		);
