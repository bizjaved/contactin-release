	...
	public static function get_patterns(): array {
		...
		$base['support']['high'] = array_merge(
			...
			array(
				...
				'test sample rejected',
				'laboratory report mismatch',
				'calibration certificate missing',
				'surveillance due date issue',
				'certificate suspension warning',
				'certificate reinstatement request',
				'logo usage query',
			)
		);
		...
		$base['feedback']['high'] = array_merge(
			...
			array(
				'clearer nonconformity comments',
				'more practical audit feedback',
				'faster certificate issuance',
				'better turnaround for reports',
				'better technical guidance',
				'improve audit planning communication',
				'improve transparency of grading',
				'more consistent auditor approach',
				'better digital dashboard',
		...
		$base['feedback']['medium'] = array_merge(
			...
			array(
				'clearer audit report',
				'faster report turnaround',
				'better auditor guidance',
				'improve audit communication',
				'digital certificate access',
				'better scheduling process',
				'better client onboarding',
				'clear fee structure',
				'improve certificate verification portal',
			)
		);
		...
		$base['complaint']['high'] = array_merge(
			$base['complaint']['high'],
			array(
				'audit findings unfair',
				'inconsistent audit',
				'certificate delay complaint',
				'poor auditor conduct',
				'inspection quality issue',
				'report quality issue',
				'biased auditor',
				'conflict of interest',
				'unprofessional behavior',
				'wrong nonconformity grading',
				'incorrect report conclusions',
				'unexpected additional charges',
				'hidden certification fees',
				'complaint ignored by certification body',
		...
		$base['complaint']['medium'] = array_merge(
			...
			array(
				'slow response from coordinator',
				'unclear process steps',
				'repeated document requests',
				'delayed inspection slots',
				'unclear invoice breakdown',
				'communication gaps',
			)
		);
		...
		$base['question']['medium'] = array_merge(
			...
			array(
				...
				'who is accredited auditor',
				'can audit be remote',
				'is multi site included',
				'how often calibration required',
				'how to verify certificate online',
				'what are appeal timelines',
				'when will certificate be issued',
			)
		);
		...
		$base['spam']['high'] = array_merge(
			...
			array(
				...
				'buy iso certificate online',
				'fake certificate provider',
				'instant certification no documents',
				'pay and get certificate same day',
				'forged test report',
				'counterfeit calibration certificate',
				'phishing certification portal',
				'fake accreditation logo',
			)
		);
