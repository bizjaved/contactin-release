	...
	public static function get_patterns(): array {
		...
		$base['support']['high'] = array_merge(
			...
			array(
				...
				'flight reschedule',
				'flight cancellation',
				'hotel voucher missing',
				'transfer not arranged',
				'visa processing delay',
				'travel date change request',
				'name correction on ticket',

				// Disruptions
				'missed connection',
				'schedule change not informed',
				'overbooked flight',
				'denied boarding',
				'hotel overbooked',
				'no pickup at airport',
				'tour guide absent',
				'activity canceled',
				'excursion not provided',

				// Refunds/Reissues
				'refund status',
				'refund delayed',
				'ticket reissue pending',
				'credit shell issue',
				'travel credit not usable',

				// Documentation
				'wrong passport details in ticket',
				'visa document rejected',
		...
		$base['support']['medium'] = array_merge(
			...
			array(
				...
				'baggage add-on issue',
				'special assistance request',
				'wheelchair request status',
				'late check-in support',
				'hotel room preference request',
		...
		$base['feedback']['high'] = array_merge(
			...
			array(
				...
				'better emergency support abroad',
				'proactive flight update alerts',
				'clearer package inclusions',
				'more transparent exclusions',
				'better local partner quality',
				'better destination recommendations',
				'more flexible itinerary options',
				'improve visa documentation guidance',
				'better refund tracking experience',
		...
		$base['feedback']['medium'] = array_merge(
			...
			array(
				...
				'better communication during trip',
				'real-time travel updates',
				'improve booking experience',
				'better app usability',
				'clearer trip checklist',
				'more local activity options',
		...
		$base['complaint']['high'] = array_merge(
			...
			array(
				...
				'bait and switch package',
				'promised inclusions missing',
				'fraudulent booking confirmation',
				'ticket canceled without notice',
				'visa service negligence',
				'passport mishandling',
				'unethical upselling',
				'agent stopped responding',
				'unsafe transport arranged',
				'security concern during trip',
			)
		);
		...
		$base['complaint']['medium'] = array_merge(
			...
			array(
				'slow response from agent',
				'unclear cancellation charges',
				'late itinerary delivery',
				'poor coordination',
				'hotel not as expected',
				'long transfer wait',
				'incomplete trip briefing',
				'post-trip support poor',
			)
		);
		...
		$base['question']['high'] = array_merge(
			...
			array(
				...
				'covid travel rules',
				'entry requirements for destination',
		...
		$base['question']['medium'] = array_merge(
			...
			array(
				'can i customize package',
				'can i add extra nights',
				'what payment methods accepted',
				'is emi available for package',
				'can i get invoice with tax details',
				'what is check-in time hotel',
		...
		$base['spam']['high'] = array_merge(
			...
			array(
				'free international trip winner',
				'pay visa fee to personal account',
				'fake airline ticket generator',
				'guaranteed visa without documents',
				'too cheap holiday scam',
				'phishing travel portal link',
				'share passport copy and otp now',
				'fake hotel confirmation',
				'fake pnr confirmation',
				'travel lottery scam',
			)
		);
