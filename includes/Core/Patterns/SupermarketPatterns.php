	...
	public static function get_patterns(): array {
		...
		$base['support']['high'] = array_merge(
			...
			array(
				...
				'substituted item not acceptable',
				'wrong quantity delivered',
				'incorrect weight item',

				// In-store Support
				'barcode not scanning',
				'self checkout issue',
				'pos machine not working',
				'long queue at checkout',
		...
		$base['support']['medium'] = array_merge(
			...
			array(
				'delivery slot change request',
				'address update for order',
				'order reschedule request',
				'return pickup request',
				'invoice request',
				'tax invoice needed',
				'product availability check',
				'restock estimate request',
			)
		);
		...
		$base['complaint']['high'] = array_merge(
			...
			array(
				...
				'overcharged at checkout',
				'incorrect pricing',
				'price mismatch shelf vs bill',
				'rude cashier',
				...
				'food safety issue',
				'fraudulent discount claim',
				'fake promotion',
				'refund denied without reason',
				'complaint ignored',
				'delivery agent misconduct',
				'missing expensive item',
			)
		);
		...
		$base['complaint']['medium'] = array_merge(
			...
			array(
				'late delivery repeatedly',
				'frequent stockouts',
				'small quantity substitutions',
				'poor replacement choices',
				'app experience poor',
				'customer care unresponsive',
				'billing confusion',
				'queue management poor',
			)
		);
		...
		$base['question']['medium'] = array_merge(
			...
			array(
				'can i schedule recurring delivery',
				'can i modify order after placing',
				'what is cancellation window',
				'what is replacement policy',
				'are imported products available',
				'do you have gluten free products',
				'is cash on delivery available',
				'how to get tax invoice',
			)
		);
		...
		$base['spam']['high'] = array_merge(
			...
			array(
				'free grocery voucher click now',
				'claim supermarket prize now',
				'fake loyalty points redemption link',
				'phishing grocery app login',
				'pay small fee to unlock coupons',
				'too good to be true grocery deal',
				'fake delivery refund link',
				'share otp for order verification scam',
			)
		);
