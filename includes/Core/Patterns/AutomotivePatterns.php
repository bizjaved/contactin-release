	...
	public static function get_patterns(): array {
		...
		$base['sales']['medium'] = array_merge(
			...
			array(
				...
				'delivery timeline for vehicle',
				'booking amount details',
				'corporate fleet offer',
				'festival car discounts',
		...
		$base['support']['high'] = array_merge(
			...
			array(
				...
				'insurance claim repair delay',
				'accident repair delay',
				'parts not available',

				// Billing
				'service bill dispute',
				'unexpected repair charges',
				'overcharged for parts',
				'labor charges too high',
			)
		);
		...
		$base['support']['medium'] = array_merge(
			...
			array(
				...
				'wheel alignment request',
				'wheel balancing request',
				'car wash quality issue',
			)
		);
		...
		$base['feedback']['high'] = array_merge(
			...
			array(
				'better workshop turnaround',
				'improve diagnostic accuracy',
				'clearer service explanation',
				'transparent estimate before repair',
				'better test drive experience',
				'better sales follow-up',
				'better delivery handover process',
				'improve spare parts availability',
				'improve customer lounge facilities',
		...
		$base['feedback']['medium'] = array_merge(
			...
			array(
				...
				'more service slots available',
				'clear warranty terms',
				'better app reminders for service',
			)
		);
		...
		$base['complaint']['high'] = array_merge(
			...
			array(
				...
				'poor workmanship in workshop',
				'mis-selling of add-ons',
				'forced insurance package',
				'hidden dealership charges',
				'warranty voided unfairly',
				'unsafe repair quality',
				'vehicle damaged during service',
			)
		);
		...
		$base['complaint']['medium'] = array_merge(
			...
			array(
				'service delayed repeatedly',
				'advisor not responding',
				'poor customer handling',
				'unclear billing items',
				'booking promises not honored',
				'spare delivery too late',
			)
		);
		...
		$base['question']['high'] = array_merge(
			...
			array(
				...
				'how to book test drive',
				'what are emi options',
				'how long vehicle delivery takes',
		...
		$base['question']['medium'] = array_merge(
			...
			array(
				...
				'which fuel type is better',
				'can i exchange old car',
				'can i transfer booking',
				'what accessories are included',
				'how to check service history',
				'is pickup and drop available',
				'what is cancellation policy for booking',
			)
		);
		...
		$base['spam']['high'] = array_merge(
			...
			array(
				'guaranteed car lottery winner',
				'pay token now for instant allotment scam',
				'fake dealership payment link',
				'phishing service payment link',
				'share otp for vehicle booking confirmation',
				'fake insurance renewal call for car',
				'discounted car scam offer',
			)
		);
