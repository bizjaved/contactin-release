	...
	public static function get_patterns(): array {
		...
		$base['feedback']['high'] = array_merge(
			...
			array(
				...
				'personalized offers',
				'better wealth advisory',
				'clear fee disclosure',
				'transparent loan terms',
				'faster loan approval workflow',
				'better dispute resolution',
				'stronger fraud protection',
				'better chatbot support',
		...
		$base['complaint']['high'] = array_merge(
			...
			array(
				...
				'unauthorized loan insurance',
				'loan harassment',
				'recovery harassment',
				'harassing calls',
				'account closed without notice',
				'unjustified account freeze',
				'refused dispute',
				'complaint ignored',
				'ombudsman complaint',
				'privacy breach',
		...
		$base['complaint']['medium'] = array_merge(
			...
			array(
				...
				'long call wait time',
				'branch wait too long',
				'unclear charges',
				'fee not explained',
				'statement confusing',
				'delayed loan decision',
		...
		$base['question']['high'] = array_merge(
			...
			array(
				'how to open account',
				'documents required for account',
				'minimum balance',
				...
				'what is foreclosure charge',
				'how to close account',
				'how to unblock card',
				'how to dispute charge',
				'how to reset netbanking password',
				'how to enable international usage',
				'what is daily transfer limit',
				'what is cash withdrawal limit',
			)
		);
		...
		$base['question']['medium'] = array_merge(
			...
			array(
				...
				'prepayment penalty',
				'late payment charge',
				'how long for card delivery',
				'how to link account to app',
				'how to update kyc',
				'branch timings',
				'holiday hours',
			)
		...
		$base['spam']['high'] = array_merge(
			...
			array(
				...
				'urgent kyc update link',
				'suspend account immediately',
				'share otp',
				'share pin',
				'share cvv',
				'share internet banking password',
				'account will be blocked click here',
				'fake bank alert',
				'winner of bank lottery',
				'quick loan guaranteed approval',
				'instant loan no documents',
