...
final class BusinessPatterns
{
    ...
    {
        return [
            'generic'       => __('Generic / Multi-Industry', 'contact-inbox-pro'),
            'saas'          => __('SaaS / Software', 'contact-inbox-pro'),
            'ecommerce'     => __('E-commerce / Retail', 'contact-inbox-pro'),
            'service'       => __('Service / Consulting', 'contact-inbox-pro'),
            'healthcare'    => __('Healthcare / Medical', 'contact-inbox-pro'),
            'education'     => __('Education / Training', 'contact-inbox-pro'),
            'hospitality'   => __('Hospitality / Travel', 'contact-inbox-pro'),
            'banking'       => __('Banking / Financial Services', 'contact-inbox-pro'),
            'insurance'     => __('Insurance', 'contact-inbox-pro'),
            'embassy'       => __('Embassy / High Commission', 'contact-inbox-pro'),
            'qualityagency' => __('Quality Agency / Certification', 'contact-inbox-pro'),
            'travelagency'  => __('Travel Agency / Tours', 'contact-inbox-pro'),
            'supermarket'   => __('Supermarket / Grocery', 'contact-inbox-pro'),
            'legal'         => __('Legal Services / Law Firm', 'contact-inbox-pro'),
            'logistics'     => __('Logistics / Courier', 'contact-inbox-pro'),
            'telecom'       => __('Telecom / ISP', 'contact-inbox-pro'),
            'automotive'    => __('Automotive / Dealership', 'contact-inbox-pro'),
            'construction'  => __('Construction / Home Services', 'contact-inbox-pro'),
            'realestate'    => __('Real Estate', 'contact-inbox-pro'),
        ];
    }
