...
final class WebhookRoutes {
	...
	public static function register_routes(): void {
		...
		register_rest_route(
			$namespace,
			Config::WEBHOOK_ENDPOINT_SUBMIT,
			array(
				'methods'             => 'POST',
				'callback'            => array( WebhookController::class, 'submit' ),
		...
		register_rest_route(
			$namespace,
			Config::WEBHOOK_ENDPOINT_STATUS,
			array(
				'methods'             => 'POST',
				'callback'            => array( WebhookController::class, 'update_status' ),
				'permission_callback' => array( __CLASS__, 'permission_public' ),
				'show_in_index'       => false,
			)
		);
		...
		register_rest_route(
			$namespace,
			Config::WEBHOOK_ENDPOINT_STATUS . '/get',
			array(
				'methods'             => 'POST',
				'callback'            => array( WebhookController::class, 'get_status' ),
				'permission_callback' => array( __CLASS__, 'permission_public' ),
				'show_in_index'       => false,
			)
		);
