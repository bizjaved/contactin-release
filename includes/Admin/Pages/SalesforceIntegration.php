...
class SalesforceIntegration {
	...
	public function render_page(): void {
		...
		$mapping            = $settings['mapping'] ?? array();
			...
			<div class="sf-oauth-flow">
				...
				<div class="sf-oauth-step <?php echo $is_authorized ? 'is-complete' : ''; ?>">
					...
					<div class="sf-oauth-step-copy">
						...
						<span class="sf-step-hint"><?php printf( esc_html__( 'Callback URL: %s', 'contactin' ), esc_html( $callback_url ) ); ?></span>
					</div>
				</div>
	...
	private function render_field_mapping_tab( array $settings ): void {
		$mapping       = $settings['mapping'] ?? array();
		$plugin_fields = array( 'name', 'email', 'phone', 'subject', 'message', 'intent_category', 'intent_confidence' );
		$field_labels  = array(
